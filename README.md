...
The 2D panel is SVG output generated by Helix 2D Flat. The 3D panel shows a
molecular DNA helix for structural context; it is a reference image, not
program output.

<table>
  <tr>
    <th>2D schematic generated by this program</th>
    <th>3D molecular reference</th>
  </tr>
  <tr>
    <td align="center"><img src="examples/comparison_duplex_2d.svg" alt="Flat 2D DNA duplex generated by Helix 2D Flat" width="330"></td>
    <td align="center"><img src="assets/dna_helix_3d.png" alt="Three-dimensional molecular rendering of a DNA helix" width="620"></td>
  </tr>
</table>
